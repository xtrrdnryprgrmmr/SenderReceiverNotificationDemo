...
public class MailModel extends BaseModel {
    ...
    public By lastSenderContentTo = By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/androidx.drawerlayout.widget.DrawerLayout/android.widget.RelativeLayout/android.widget.RelativeLayout/android.widget.FrameLayout/androidx.viewpager.widget.ViewPager/android.widget.FrameLayout/android.view.ViewGroup/android.webkit.WebView/android.webkit.WebView/android.view.View[2]");
    ...
    public void verifyMailIsSend() {
        System.out.println("sendedMailSubject : " + getText(lastSenderSubject));
        System.out.println("sendedTo : " + getText(lastSenderTo));
        System.out.println("sendedContent : " + getText(lastSenderContentTo));
        assertElementContainsText(Constants.senderMailSubject, lastSenderSubject);
        assertElementContainsText(Constants.senderMail, lastSenderTo);
        assertElementContainsText(Constants.senderMailContent, lastSenderContentTo);
        System.out.println("[TEST] Mobile Test Automation Part Mail sended successfully");
    }
    ...
    public void verifyMailFromSender() {
        ...
        assertElementContainsText(Constants.senderMailSubject, lastSenderSubject);
        assertElementContainsText(Constants.senderMail, lastSenderTo);
        assertElementContainsText(Constants.senderMailContent, lastSenderContent);
    ...
    public void verifyMailFromReceiver() {
        ...
        System.out.println("[TEST] Mobile Test Automation Part Reply send successfully");
    }
